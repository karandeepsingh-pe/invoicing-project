...
export const BULK_TECHNICIAN_COLUMNS = [
  ...
  { key: "annualSalary", header: "Annual Salary (Dedicated)" },
  { key: "isRebadged", header: "Rebadged (yes/no)" },
  { key: "rebadgedHourlyRate", header: "Rebadged Hourly Rate" },
  { key: "rebadgedDayRate", header: "Rebadged Day Rate" },
  { key: "rebadgedMonthlyRate", header: "Rebadged Monthly Rate" },
  { key: "rebadgedOtRate", header: "Rebadged OT Rate" },
  { key: "rebadgedWeekendRate", header: "Rebadged Weekend Rate" },
