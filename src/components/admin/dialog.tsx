...
export function Dialog({
  ...
  const overlay = open ? (
    <div
      ...
      className="fixed inset-0 z-[100] flex items-center justify-center overflow-y-auto bg-black/50 px-4 py-8 backdrop-blur-sm animate-fade-in dark:bg-black/70"
    >
      <div
